        ...
        changeData(cultivar) {
            ...
            for (let index = 0; index < this.items.length; index++) {
                if (this.items[index].cultivar == cultivar) {
                    ...
                    count++;
                    if(this.items[index].subsrateTargetSub.length > 0){
                        for (
                            let index1 = 0;
                            index1 < this.items[index].subsrateTargetSub.length;
                            index1++
                        ) {
                            var subData = this.items[index].subsrateTargetSub[index1];
