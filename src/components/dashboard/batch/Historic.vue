<template>
    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <div class="subsrate-content">
            <h3>Historic Batches </h3>
            <!-- <h3>EC & pH Historic</h3> -->
                                    ...
                                    >
                                        <li class="nav-item">
                                            <a
                                                ...
                                                aria-selected="false"
                                                class="nav-link filterHistoryDateBtn"
            ...
            >
                <div
                    class="tab-pane fade show active"
                    id="pills-Flower-Historic"
                    role="tabpanel"
                    aria-labelledby="pills-Flower-Historic-tab"
                >
                    <div class="table-responsive">
                        <b-table
                            :items="items"
                            :fields="fields"
                            id="FlowerHistoricTable"
                            small
                        >
...
export default {
    ...
    methods: {
        ...
        clearfilter() {
            ...
            this.byRoomID = null;
            this.byCultivar = "";
            $(".filterHistoryDateBtn").removeClass("active").attr("aria-selected", false);
