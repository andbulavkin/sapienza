                        ...
                        <template #cell(plantingDate)="data">
                            <b-input-group v-if="selectedRow[data.index]">
                                <b-form-input
                                    ...
                                    :max="maxDate"
                                    @input="changeDate(data.index, 'editData')"
                                ></b-form-input>
                            ...
                            >
                                ...
                                <b-td>
                                    <b-input-group>
                                        <b-form-input
                                            ...
                                            :max="maxDate"
                                            @input="changeDate(index, 'addData')"
                                        ></b-form-input>
                                        <b-input-group-append>
                                            <b-form-datepicker
                                                v-model="addRows[index].plantingDate"
                                ...
                                <b-td>
                                    <b-input-group>
                                        <b-form-input
                                            id="example-input"
                                            v-model="addRows[index].triggerDate"
                                            type="date"
                                ...
                                <b-td>
                                    <b-input-group>
                                        <b-form-input
                                            id="example-input"
                                            v-model="addRows[index].harvestDate"
                                            type="date"
                                            placeholder="YYYY-MM-DD"
                                            :min="addRows[index].triggerDate"
                                            autocomplete="off"
                                            :max="maxDate"
                                            @input="checkChangeData()"
                                        ></b-form-input>
...
export default {
    ...
    methods: {
        ...
        clearAddData(index) {
            ...
            this.addRows[index].triggerDate = "";
            this.addRows[index].harvestDate = "";
        },
        cleareditData(index) {
            ...
            this.items[index].triggerDate = "";
            this.items[index].harvestDate = "";
        },
        checkChangeData() {
            ...
            for (let newItem of this.addRows) {
                ...
                if (newItem.triggerDate != "") {
                    this.$parent.leavePage = false;
                    return false;
                }
                if (newItem.harvestDate != "") {
                    this.$parent.leavePage = false;
                    return false;
                }
            }
                ...
                .then((response) => {
                    if (response.data.data) {
                        for (let i = 0; i < response.data.data.length; index++) {
                            ...
                            if ($data.comparment == 'Vegetative') {
                                this.addRows[index].plantingDate = response.data.data[i].transplantDate;
                                this.addRows[index].triggerDate = response.data.data[i].transplantDate;
                            }
                    ...
                    //     this.addRows[index].triggerDate = response.data.data.triggerDate;
                    //     this.addRows[index].harvestDate = response.data.data.harvestDate;
                    // } 
                })
                .catch((error) => {
                    this.$toast.error(error.response.data.message, {
        ...
        changeDate(index, changeType){
            console.log(index);
            console.log(changeType);
            if (changeType == "addData") {
                this.addRows[index].triggerDate = this.addRows[index].plantingDate;
            }else{
                this.items[index].triggerDate = this.items[index].plantingDate;
            }
            this.checkChangeData();
        }
    },
    mounted() {
        this.getData();
        this.getCultivar();
        for (let index = 1; index <= this.userDetail.flower; index++) {
