                        ...
                        <template #cell(transplantDate)="data">
                            <b-input-group v-if="selectedRow[data.index]">
                                <b-form-input
                                    ...
                                    :min="items[data.index].cloneDate"
                                    :max="maxDate"
                                ></b-form-input>
                                <b-input-group-append>
                                    <b-form-datepicker
                            ...
                            >
                                ...
                                <b-td>
                                    <b-input-group>
                                        <b-form-input
                                            id="example-input"
                                            v-model="addRows[index].cloneDate"
                                            type="date"
                                            placeholder="YYYY-MM-DD"
                                            autocomplete="off"
                                            :class="errors[index] && errors[index].cloneDate?'errorMsg':''"
                                            :max="maxDate"
                                            @input="checkChangeData()"
                                        ></b-form-input>
                                        <b-input-group-append>
                                ...
                                <b-td>
                                    <b-input-group>
                                        <b-form-input
                                            id="example-input"
                                            v-model="addRows[index].transplantDate"
                                            type="date"
                                            :min="addRows[index].cloneDate"
                                            placeholder="YYYY-MM-DD"
                                            autocomplete="off"
                                            :max="maxDate"
                                            @input="checkChangeData()"
...
export default {
    ...
    methods: {
        ...
        clearAddData(index) {
            ...
            this.addRows[index].cloneDate = "";
            this.addRows[index].transplantDate = "";
        },
        cleareditData(index) {
            this.items[index].comparmentNo = "";
            this.items[index].batchID = "";
            this.items[index].cultivar = "";
            this.items[index].cloneDate = "";
            this.items[index].transplantDate = "";
        },
        checkChangeData() {
            ...
            for (let newItem of this.addRows) {
                ...
                if (newItem.cloneDate != "") {
                    this.$parent.leavePage = false;
                    return false;
                }
                if (newItem.transplantDate != "") {
                    this.$parent.leavePage = false;
                    return false;
                }
            }
                ...
                .then((response) => {
                    if (response.data.data) {
                        for (let i = 0; i < response.data.data.length; index++) {
                            ...
                            if($data.comparment == 'Vegetative' || $data.comparment == 'Mother'){
                                this.addRows[index].transplantDate = response.data.data[i].plantingDate;
                            }
    ...
    mounted() {
        this.getData();
        this.getCultivar();
        for (let index = 1; index <= this.userDetails().clone; index++) {
