<template>
    <div class="dashboard">
        ...
        <div class="content">
            <!-- Header -->
            <Header tabName="Substrate EC/pH targets" />
            <!-- Header -->
                                            ...
                                            <template v-for="(item, index) in items">
                                                ...
                                                >
                                                    ...
                                                    <td class="text-center">
                                                        <img
                                                            ...
                                                            v-if="items[index].subsrateTargetId !=''"
                                                        />
                                                    </td>
                                                    <td class="d-flex">
                                                        <span>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <SubsrateECPHTargetTr
                                                                :ParentId="item.subsrateTargetId"
                                                                v-if="subId == index"
                                                            />
                                                        </div>
                                                    </td>
...
import SubsrateECPHTargetTr from "../components/SubsrateECPHTargetTr";
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.$http
                .post(this.$apiBaseUrl + "subsrate-target/" + this.type,
                    {
        ...
        save(id) {
            this.errors = [];
            if (this.items[id].subsrateTargetId != "") {
                this.update(id);
            } else {
                this.store(id);
            }
        ...
        update(id) {
            this.$http
                .put(
                    this.$apiBaseUrl +
                    "subsrate-target/" +
                    this.items[id].subsrateTargetId,
                    this.items[id],
                    {
                        headers: {
                            Authorization: this.accessToken(),
        ...
        store(storeData, index) {
            this.$http
                .post(
                    this.$apiBaseUrl + "subsrate-target",
                    storeData,
                    {
                        headers: {
                            Authorization: this.accessToken(),
        ...
        removeEmpty() {
            if (
                ...
                this.items[this.items.length - 1].subsrateTargetId == ""
            ) {
                this.items.pop();
            }
        },
        openDelete(id, deleteType) {
            if (deleteType == "editDelete") {
                this.deleteId = this.items[id].subsrateTargetId;
            }
        ...
        deleteData() {
            ...
            if (this.deleteType != "editDelete") {
                ...
                this.$http
                    .delete(this.$apiBaseUrl + "subsrate-target/" + this.deleteId, {
                        headers: {
                            Authorization: this.accessToken(),
                        },
                    })
        ...
        duplicate(index) {
            ...
            this.addRows.push({
                ...
                subsrateTargetSub: duplicateData.subsrateTargetSub,
            });
